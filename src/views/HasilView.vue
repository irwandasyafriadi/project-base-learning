  ...
  <div id="blog">
    <Container>
      <div class="mb-12 space-y-2 text-center">
        <h2 class="text-3xl font-bold text-gray-800 md:text-4xl dark:text-white">Hasil PjBL</h2>
        <p class="lg:mx-auto lg:w-6/12 text-gray-600 dark:text-gray-300">
          Terdapat 3 jenis hasil yaitu video, artikel, dan poster
        </p>
      </div>
      <div class="grid gap-8 md:grid-cols-2 lg:grid-cols-3">
        <div class="group p-6 sm:p-8 rounded-3xl bg-white border border-gray-100 dark:shadow-none dark:border-gray-700 dark:bg-gray-800 bg-opacity-50 shadow-2xl shadow-gray-600/10">
          ...
          <div class="mt-6 relative">
            ...
            <a class="inline-block" href="#">
              <span class="text-info dark:text-blue-300">Lihat</span>
            </a>
          </div>
        </div>
        ...
        <div class="group p-6 sm:p-8 rounded-3xl bg-white border border-gray-100 dark:shadow-none dark:border-gray-700 dark:bg-gray-800 bg-opacity-50 shadow-2xl shadow-gray-600/10">
          ...
          <div class="mt-6 relative">
            ...
            <a class="inline-block" href="#">
              <span class="text-info dark:text-blue-300">Baca Selengkapnya</span>
            </a>
          </div>
